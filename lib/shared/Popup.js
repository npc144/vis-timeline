...
class Popup {
  ...
  show(doShow) {
    ...
    if (doShow === true) {
      ...
      var maxHeight = this.frame.parentNode.parentNode.clientHeight;
      var maxWidth = this.frame.parentNode.parentNode.clientWidth;
      ...
      if (this.overflowMethod == 'flip' || this.overflowMethod == 'none') {
        ...
        top += this.frame.parentNode.parentNode.scrollTop;
